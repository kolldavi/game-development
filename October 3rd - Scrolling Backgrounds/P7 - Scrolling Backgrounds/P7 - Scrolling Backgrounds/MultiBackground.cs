 ...
 *   Allows for multiple background layers and Scrolling backgrounds
 * -----------------------------------------------------------------
 * 
 * Used in P7, but can be used independently in other projects
 */
...
// Change this namespace or add it () to the program that uses it
